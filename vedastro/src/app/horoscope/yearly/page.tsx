	...
	return (
		<section className="container mx-auto px-4 py-10 text-white">
			<div className="max-w-3xl rounded-3xl border border-white/10 bg-slate-950/80 p-6 md:p-8">
				...
				<h1 className="mt-3 text-4xl font-black">Yearly Horoscope</h1>
				<p className="mt-4 text-slate-400">Yearly horoscope route restored. Add the yearly forecast UI later.</p>
				<div className="mt-6">
