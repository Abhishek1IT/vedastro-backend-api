	...
	return (
		<section className="container mx-auto px-4 py-10 text-white">
			<div className="max-w-3xl rounded-3xl border border-white/10 bg-slate-950/80 p-6 md:p-8">
				...
				<h1 className="mt-3 text-4xl font-black">Daily Horoscope</h1>
				<p className="mt-4 text-slate-400">Daily horoscope route restored. Add the daily forecast module here when ready.</p>
				<div className="mt-6">
